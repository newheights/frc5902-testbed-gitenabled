...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("autoGearLeft NOT DONE", new autoGearLeft());
        SmartDashboard.putData("autoGearRight NOT DONE", new autoGearRight());
        SmartDashboard.putData("driveGearStraight", new driveGearStraight());
        SmartDashboard.putData("driveGearRightTurn NOT DONE", new driveGearRightTurn());
        SmartDashboard.putData("driveGearLeftTurn NOT DONE", new driveGearLeftTurn());
    ...
    // Tell Each button what to do
        ...
        buttonX3.whileHeld(new startShooter(.95));
        ...
        buttonJoy5.whenPressed(new shimmyShake());
    }
